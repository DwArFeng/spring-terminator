package com.dwarfeng.springterminator.base.stack.i18n;
 ...
 *
 * <p>
 * 消息目录将资源所属模块与资源基础名称绑定，供 Spring Terminator 内部国际化机制进行模块感知的资源查找。
 *
 * <p>
 * 该类型属于 Spring Terminator 内部集成协议，不承诺面向第三方的源码或二进制兼容性。
 *
 * @param module   资源所属模块。

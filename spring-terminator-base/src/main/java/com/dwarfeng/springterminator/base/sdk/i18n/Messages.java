package com.dwarfeng.springterminator.base.sdk.i18n;

import com.dwarfeng.springterminator.base.internal.i18n.ResourceMessageResolver;
import com.dwarfeng.springterminator.base.stack.i18n.MessageCatalog;
import com.dwarfeng.springterminator.base.stack.i18n.MessageResolver;
 ...
 *
 * <p>
 * 该工具为 Spring Terminator 各模块提供统一的语言环境调度、资源查找、格式化与缺失资源降级。
 *
 * <p>
 * 该类型属于 Spring Terminator 内部集成机制。
 *
 * @author DwArFeng
 * @since 3.0.0
 */
